...
public class InsertCustomerConfig {
    ...
    public InsertCustomerUseCase insertCustomerUseCase(FindAddresByZipCodeAdapter findAddresByZipCodeAdapter,
                                                       ...
                                                       SendCpfValidationAdapter sendCpfValidationAdapterter){
        return new InsertCustomerUseCase(findAddresByZipCodeAdapter, insertCustomerAdapter, sendCpfValidationAdapterter);
    }
}
